...
//                   {columnOrder.length > 0 || isSystemLocked ? (
//                     <></>
//                   ) : (
//                     <div className="border border-dashed p-20 flex justify-center items-center">
...
export default function EditCourse(props: { courseId: string }) {
  const { fetchCategories, fetchInstructors } = useCourseStore(
    useShallow((state) => ({
      fetchCategories: state.fetchCategories,
      fetchInstructors: state.fetchInstructors,
    })),
